...
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://localhost/bblitzerHW5"
...
class TweetForm(FlaskForm):
    ...
    email = StringField("What is your email connected to your twitter account?", validators=[Required()])
